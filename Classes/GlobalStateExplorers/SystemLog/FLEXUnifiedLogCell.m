...
NSString *const kFLEXUnifiedLogCellIdentifier = @"FLEXUnifiedLogCellIdentifier";

@interface FLEXUnifiedLogCell ()
...
@implementation FLEXUnifiedLogCell
...
- (void)setLogMessage:(FLEXUnifiedLogMessage *)logMessage {
...
static const UIEdgeInsets kFLEXUnifiedMessageCellInsets = {10.0, 10.0, 10.0, 10.0};

- (void)layoutSubviews {
    [super layoutSubviews];
    
    self.logMessageLabel.attributedText = self.logMessageAttributedText;
    self.logMessageLabel.frame = UIEdgeInsetsInsetRect(self.contentView.bounds,
                                                       kFLEXUnifiedMessageCellInsets);
}
...
+ (CGFloat)preferredHeightForLogMessage:(FLEXUnifiedLogMessage *)logMessage inWidth:(CGFloat)width {
    UIEdgeInsets insets = kFLEXUnifiedMessageCellInsets;
...
+ (NSAttributedString *)attributedTextForLogMessage:(FLEXUnifiedLogMessage *)logMessage highlightedText:(NSString *)highlightedText {
